              ...
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                ...
                <div className="flex sm:flex-col items-center sm:items-end gap-2 shrink-0 border-t sm:border-t-0 pt-3 sm:pt-0">
                  <button
                    ...
                    onClick={() =>
                      onOpenExerciseAlternative(exercise, currentWorkout.title)
                    }
                    className="w-full sm:w-auto px-3 py-1.5 text-xs font-semibold text-slate-700 hover:text-slate-900 bg-slate-100 hover:bg-slate-200/80 rounded-lg transition-colors text-center"
                  >
                    View alternative
                  </button>
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-teal-700 hover:text-teal-800 bg-teal-50 hover:bg-teal-100/80 rounded-lg border border-teal-200/60 transition-colors"
                  >
